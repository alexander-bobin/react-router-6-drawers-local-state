  ...
  return (
    <>
      ...
      <ul className="mt-4 list-disc">
        <li className="ml-4">A code example for "local state drawers". Go to <a href="https://alexander-bobin.github.io/react-router-6-drawers-query-string/" className="text-blue-500 hover:underline">React Router 6 Query String Drawers</a> to see another approach.</li>
      </ul>
